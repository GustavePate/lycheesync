...
test_all:
	python main.py ./tmptest/ /home/guillaume/git/Lychee/ ./ressources/test_conf.json -v -d
...
testdev:
	py.test -c ./ressources/pytest.ini --cov=lycheesync --pep8  --showlocals  --duration=3 -v  -s --confpath=${PWD}/ressources/test_conf.json  -k test_quotes_in_album_name
